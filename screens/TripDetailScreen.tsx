...
export default function TripDetailScreen({
  ...
  async function checkEntryRequirements() {
    ...
    try {
      ...
      // Synced, not appended. These used to be added one at a time as ordinary
      // manual items, which meant re-running the check duplicated them and
      // fixing a passport left them behind forever. The sync also adopts and
      // clears rows left over from that.
      await syncEntryRequirementChecklist(
        trip.id,
        failing.map((r) => checklistLabelForEntryIssue(r.travelerName, requirement.countryName))
      );
